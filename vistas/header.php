...
<html>
  <head>
   ...
   <title>Sistema Asistencia | Admin</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-lg"><b>Sistema</b> ADMIN</span>
    </a>
...
-->
      ...
      <li><a href="#"><i class="fa  fa-exclamation-circle"></i> <span>Acerca de</span><small class="label pull-right bg-yellow">JRDA</small></a></li>   
